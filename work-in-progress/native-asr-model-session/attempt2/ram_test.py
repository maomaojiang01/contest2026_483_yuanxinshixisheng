...
if mode=='reenter':
    ...
    expected='ee463640ce1d550f9460963aa8da72fe1f519af09d249b24fb58c3cf3974576f'
    ...
    with port() as s:
        ...
        crc_check(0x40c00800,len(data),'e80e6d84')
        ...
        for source,target,size,crc in [(0x41c00800,0x80000000,72024848,'2af64aa7'),
                                      (0x40c00800,0x40400000,14685504,'6aae8ca2')]:
