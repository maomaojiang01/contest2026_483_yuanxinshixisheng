...
MANIFEST = HERE / "ram-package-wakepartial.json"
PAYLOAD = HERE / "voice-rule-provision-wakepartial-first-firmware.bin"
DOWNLOADER = HERE / "fastboot_ram_download.py"
LOADER = HERE / "load_ram.py"
USB_DEPS = HERE / "vendor" / "pyusb"
...
def main():
    ...
    usb_result = HERE / ("wakepartial-usb-" + stamp + ".json")
    acceptance = HERE / ("wakepartial-boot-" + stamp + ".json")
