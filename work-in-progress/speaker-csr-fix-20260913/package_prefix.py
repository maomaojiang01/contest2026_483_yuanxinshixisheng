...
FIRMWARE = Path("/home/swl/openvela/cmake_out/velavision_speaker_csr_20260913/nuttx.bin")
PREFIX = Path("/home/swl/openvela/work/native-asr-model-session/encoder1/encoder-first-firmware.bin")
OUTPUT = HERE / "speaker-csr-prefix.bin"
REPORT = HERE / "prefix-package.json"

EXPECTED_FIRMWARE = "3421500574ee083204d3e797d1e8faf9126a76921621e561db3b10be408739ef"
