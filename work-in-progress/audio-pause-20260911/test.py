...
r=pathlib.Path('E:/openvela/VelaVision');out=r/'work-in-progress/audio-pause-20260911'
...
s=s.replace(' puts("PASS pause normal/overflow/frozen-clock; v3:', ''' memset(&s,0,sizeof s);assert(!pio_run16(&p,1,4096000,data,96000,128,&r));
 ...
 puts("PASS S16 recipe; pause normal/overflow/frozen-clock; v3:''')
