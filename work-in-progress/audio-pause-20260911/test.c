...
int main(void){struct sim s={0};struct pio_result r;static uint32_t data[96000];
 ...
 puts("PASS S16 recipe; pause normal/overflow/frozen-clock; v3: vendor sum4 FIFO, strict16word prefill, raw diagnostics,3200TX/48000RX and v2 bounds");return 0;}
