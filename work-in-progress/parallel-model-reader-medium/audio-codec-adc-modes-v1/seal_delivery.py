...
(R/'delivery.json').write_text(json.dumps({'scope':'Executable codec engineering candidate; host mocks only, root target validation pending','files':files},indent=2)+'\n')
