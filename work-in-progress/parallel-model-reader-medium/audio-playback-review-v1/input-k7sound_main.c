...
int main(int argc, char **argv)
{
  ...
  playing = !strcmp(argv[1], "tone") || !strcmp(argv[1], "tone-reset") || !strcmp(argv[1], "tone-clear") || !strcmp(argv[1], "tone-clockwait") || replay;
  bool common = !strcmp(argv[1], "capture-common");
  bool vmid = !strcmp(argv[1], "capture-vmid");
  bool recording = !strcmp(argv[1], "capture") || !strcmp(argv[1], "capture-reset") || !strcmp(argv[1], "capture-clear") || !strcmp(argv[1], "capture-clockwait") || common || vmid;
