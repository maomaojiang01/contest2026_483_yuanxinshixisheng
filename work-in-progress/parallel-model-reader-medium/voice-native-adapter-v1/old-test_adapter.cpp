...
int main(){mixed_view_and_error();races();invalid_ip_and_text();ready_and_busy();fences();boundaries();connection();std::printf("PASS checks=%u; real candidate functions, injected mock hardware only; no radio/IP acceptance\n",checks.load());}
