"""Use the reviewed RAM-only OTG helpers for the prompt-ASR package."""
...
environment["K7VOICE_MANIFEST"] = str(HERE / "prompt-asr2-prefix-package.json")
environment["K7VOICE_PAYLOAD"] = str(HERE / "prompt-asr2-prefix.bin")

if len(sys.argv) != 2 or sys.argv[1] not in ("enter", "transfer"):
    raise SystemExit("usage: load_prompt2.py enter|transfer")
