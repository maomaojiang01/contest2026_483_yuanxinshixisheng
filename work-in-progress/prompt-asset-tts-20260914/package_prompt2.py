...
BUILD = Path("/home/swl/openvela/cmake_out/velavision_prompt_asr2_20260914")
PREFIX = Path("/home/swl/openvela/work/native-asr-model-session/encoder1/encoder-first-firmware.bin")
FIRMWARE_RESULT = HERE / "prompt2-firmware-result.json"
...
required = ("k7_asr_microphone_text", "k7sound_speak_mono16", "pio_play_mono16")
