...
BUILD = Path("/home/swl/openvela/cmake_out/velavision_prompt_asr_direct_clean_tls_20260914")
PREFIX = Path("/home/swl/openvela/work/native-asr-model-session/encoder1/encoder-first-firmware.bin")
FIRMWARE_RESULT = HERE / "firmware-result-clean-tls.json"
