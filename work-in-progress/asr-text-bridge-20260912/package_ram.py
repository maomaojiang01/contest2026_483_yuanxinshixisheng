"""Build the bounded RAM-only encoder-prefix plus ASR text firmware payload."""
...
FIRMWARE = Path("/home/swl/openvela/cmake_out/velavision_voice_asr_text_20260912/nuttx.bin")
PREFIX = Path("/home/swl/openvela/work/native-asr-model-session/encoder1/encoder-first-firmware.bin")
OUTPUT = HERE / "asr-text-first-firmware.bin"
REPORT = HERE / "ram-package.json"

EXPECTED_FIRMWARE = "b3f30aad3118ae7b1cf5960b09bf8c2330eac272685999569f8a88ee53df4442"
