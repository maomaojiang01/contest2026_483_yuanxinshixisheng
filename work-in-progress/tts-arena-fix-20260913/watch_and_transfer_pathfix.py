...
PAYLOAD = HERE / "spoken-tts-gated-pathfix-prefix.bin"
MANIFEST = HERE / "pathfix-prefix-package.json"
EXPECTED_SHA256 = "f3b5d6cb02d064369216d7861a2dc68989dcc709751e58b0499b100ffd85cd83"
VID_PID = "18d1:4d00"
...
def main():
    lock_path = HERE / "transfer-watch-pathfix.lock"
    ...
    while time.monotonic() < deadline:
        ...
        result = subprocess.run(
            [sys.executable, str(HERE / "load_pathfix.py"), "transfer"],
