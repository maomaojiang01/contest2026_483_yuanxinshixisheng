...
BUILD = SDK / 'cmake_out/velavision_spoken_tts_asr_arena_fix_20260913'
RUNTIME = HERE / 'speech-runtime-fixed.arm64.o'
EXPECTED_RUNTIME = 'd1adbf51816d5a0a5ca7e6aae2d113aceb9c48ebf1933f5b4f11a2646138c955'
...
if sha(RUNTIME) != EXPECTED_RUNTIME:
    raise RuntimeError('fixed speech runtime hash changed')
if BUILD.exists():
