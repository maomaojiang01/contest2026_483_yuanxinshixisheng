...
PAYLOAD = HERE / "spoken-tts-gated-speechcache-prefix.bin"
MANIFEST = HERE / "speechcache-prefix-package.json"
EXPECTED_SHA256 = "096ec8e043c61a51204fa33dbee50d5439afc97146ccf52ef75774eaeca413a1"
VID_PID = "18d1:4d00"
...
def main():
    lock_path = HERE / "transfer-watch-speechcache.lock"
    ...
    while time.monotonic() < deadline:
        ...
        result = subprocess.run(
            [sys.executable, str(HERE / "load_speechcache.py"), "transfer"],
