...
PAYLOAD = HERE / "spoken-tts-gated-envalloc2-prefix.bin"
MANIFEST = HERE / "envalloc2-prefix-package.json"
EXPECTED_SHA256 = "06e6e2e209aac291f4ad1144ab57089d90e8d470bfb186006e6970cd224637f7"
VID_PID = "18d1:4d00"
...
def main():
    lock_path = HERE / "transfer-watch-envalloc2.lock"
    ...
    while time.monotonic() < deadline:
        ...
        result = subprocess.run(
            [sys.executable, str(HERE / "load_envalloc2.py"), "transfer"],
