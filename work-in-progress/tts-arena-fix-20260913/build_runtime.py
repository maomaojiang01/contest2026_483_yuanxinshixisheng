...
CURRENT = SDK / 'work/velavision-project/work-in-progress/tts-spoken-flow-20260913/tts-with-current-asr.arm64.o'
...
replacement = HERE / 'offline-tts-vits-model.cc.o'
