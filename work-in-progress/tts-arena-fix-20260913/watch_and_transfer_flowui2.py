...
PAYLOAD = HERE / "spoken-tts-gated-flowui2-prefix.bin"
MANIFEST = HERE / "flowui2-prefix-package.json"
EXPECTED_SHA256 = "46110f83e50b878b9d35ea27cf6685e5d72d4b29fac3a31ff0cdc7a59829eca1"
VID_PID = "18d1:4d00"
...
def main():
    lock_path = HERE / "transfer-watch-flowui2.lock"
    ...
    while time.monotonic() < deadline:
        ...
        result = subprocess.run(
            [sys.executable, str(HERE / "load_flowui2.py"), "transfer"],
