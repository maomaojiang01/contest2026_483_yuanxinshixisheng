...
PAYLOAD = HERE / "spoken-tts-gated-prefix.bin"
MANIFEST = HERE / "gated-prefix-package.json"
EXPECTED_SHA256 = "17d264568e8fe810da78a95b317549eb8a5ef54e236634c85b0813a517322c8e"
VID_PID = "18d1:4d00"
...
def main():
    lock_path = HERE / "transfer-watch.lock"
    ...
    while time.monotonic() < deadline:
        ...
        result = subprocess.run(
            [sys.executable, str(HERE / "load_gated.py"), "transfer"],
