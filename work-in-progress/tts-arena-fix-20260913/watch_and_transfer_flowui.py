...
PAYLOAD = HERE / "spoken-tts-gated-flowui-prefix.bin"
MANIFEST = HERE / "flowui-prefix-package.json"
...
def main():
    lock_path = HERE / "transfer-watch-flowui.lock"
    ...
    while time.monotonic() < deadline:
        ...
        result = subprocess.run(
            [sys.executable, str(HERE / "load_flowui.py"), "transfer"],
