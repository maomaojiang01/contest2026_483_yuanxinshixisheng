...
PACKAGE = HERE / 'spoken-tts-gated-flowui-prefix.bin'
...
firmware_result = json.loads((HERE / 'flowui-firmware-result.json').read_text())
package_result = json.loads((HERE / 'flowui-prefix-package.json').read_text())
...
(HERE / 'flowui-package-verification.json').write_text(
