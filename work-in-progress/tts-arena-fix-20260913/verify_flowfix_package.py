...
BUILD = SDK / 'cmake_out/velavision_spoken_tts_gated_flowfix_20260914'
TOOLS = SDK / 'prebuilts/gcc/linux-x86_64/aarch64-none-elf/bin'
RUNTIME = HERE / 'speech-runtime-gated-flowfix.arm64.o'
PACKAGE = HERE / 'spoken-tts-gated-flowfix-prefix.bin'
...
firmware_result = json.loads((HERE / 'flowfix-firmware-result.json').read_text())
package_result = json.loads((HERE / 'flowfix-prefix-package.json').read_text())
...
(HERE / 'flowfix-package-verification.json').write_text(
