...
PAYLOAD = HERE / "spoken-tts-gated-flowfix-prefix.bin"
MANIFEST = HERE / "flowfix-prefix-package.json"
...
def main():
    lock_path = HERE / "transfer-watch-flowfix.lock"
    ...
    while time.monotonic() < deadline:
        ...
        result = subprocess.run(
            [sys.executable, str(HERE / "load_flowfix.py"), "transfer"],
