"""Build the bounded RAM-only encoder-prefix plus ASR audio-buffer firmware payload."""
...
FIRMWARE = Path("/home/swl/openvela/cmake_out/velavision_voice_asr_audio_buffer_20260912/nuttx.bin")
PREFIX = Path("/home/swl/openvela/work/native-asr-model-session/encoder1/encoder-first-firmware.bin")
OUTPUT = HERE / "asr-audio-buffer-first-firmware.bin"
REPORT = HERE / "ram-package.json"

EXPECTED_FIRMWARE = "af97ee7c009623681a00016d472665bc3864469e893d54dbfac227660d028675"
