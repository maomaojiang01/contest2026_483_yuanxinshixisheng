...
FIRMWARE = Path("/home/swl/openvela/cmake_out/velavision_voice_start_network_20260913/nuttx.bin")
PREFIX = Path("/home/swl/openvela/work/native-asr-model-session/encoder1/encoder-first-firmware.bin")
OUTPUT = HERE / "voice-start-network-prefix.bin"
REPORT = HERE / "prefix-package.json"

EXPECTED_FIRMWARE = json.loads((HERE / "result.json").read_text())["artifacts"]["nuttx.bin"]["sha256"]
