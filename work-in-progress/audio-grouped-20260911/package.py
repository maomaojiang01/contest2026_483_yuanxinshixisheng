...
firmware_path = Path('/home/swl/openvela/cmake_out/velavision_audio_s16_20260911/nuttx.bin')
...
assert hashlib.sha256(firmware).hexdigest() == '4b93f58381aebf60cfa98e31a1e0114450fbcd5ee64f2b709cb82d63f4d9c82c'
...
output_path = root / 'first-firmware.bin'
...
(root / 'transfer.json').write_text(json.dumps(report, indent=2) + '\n')
