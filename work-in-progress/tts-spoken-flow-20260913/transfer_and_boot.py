...
DOWNLOADER = SCRIPT_DIR.parent / "voice-rule-provision-20260912/fastboot_ram_download.py"
LOADER = SCRIPT_DIR / "load_prefix.py"
USB_DEPS = SCRIPT_DIR.parent / "voice-rule-provision-20260912/vendor/pyusb"
