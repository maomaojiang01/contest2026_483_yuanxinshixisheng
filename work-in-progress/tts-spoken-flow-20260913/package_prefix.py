...
FIRMWARE = Path("/home/swl/openvela/cmake_out/velavision_spoken_tts_20260913/nuttx.bin")
PREFIX = Path("/home/swl/openvela/work/native-asr-model-session/encoder1/encoder-first-firmware.bin")
OUTPUT = HERE / "spoken-tts-prefix.bin"
REPORT = HERE / "prefix-package.json"

EXPECTED_FIRMWARE = json.loads((HERE / "result-speech.json").read_text(encoding="utf-8-sig"))["artifacts"]["nuttx.bin"]["sha256"]
