...
static void ggml_gemv_q4_0_4x4_q8_0(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, int nr, int nc) {
    ...
    GGML_LOCAL_UNUSED(vx);
    GGML_LOCAL_UNUSED(vy);
    GGML_LOCAL_UNUSED(nr);
    GGML_LOCAL_UNUSED(nc);
    GGML_LOCAL_UNUSED(nb);
    GGML_LOCAL_UNUSED(ncols_interleaved);
    GGML_LOCAL_UNUSED(blocklen);
