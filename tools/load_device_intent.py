...
out=p/'evidence/device-intent-20260915';out.mkdir(exist_ok=True)
fw=pathlib.Path('/home/swl/openvela/cmake_out/velavision_device_intent_20260915/nuttx.bin').read_bytes()
assert len(fw)==2799680 and hashlib.sha256(fw).hexdigest()=='c3b862d2c62ced7504e1c7a4babfe317fb0c18aeee285c1c3b7f133939c5e137'
