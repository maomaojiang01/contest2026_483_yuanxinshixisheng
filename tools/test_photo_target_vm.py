...
files=['app/k7host/k7_photo_target.h','app/k7host/k7_yunet.h','host/whole_device/test_photo_target.c']
...
with tempfile.TemporaryDirectory() as folder:
 ...
 for opt in ['-O0','-O2']:
  subprocess.run(['gcc','-std=c11',opt,'-Wall','-Wextra','-Werror','-pthread',
   'host/whole_device/test_photo_target.c','-lm','-o','test'],cwd=root,check=True)
