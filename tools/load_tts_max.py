...
out=p/'evidence/tts-max-20260915';out.mkdir(exist_ok=True)
fw=pathlib.Path('/home/swl/openvela/cmake_out/velavision_tts_max_20260915/nuttx.bin').read_bytes()
assert len(fw)==2791336 and hashlib.sha256(fw).hexdigest()=='e0c66bdebb9b0dd8a8d60ec5e3f86ea20b8456484a241766ea407f7f5c6c8197'
...
if __name__ == '__main__':
    out=ROOT/'evidence/tts-max-20260915'
