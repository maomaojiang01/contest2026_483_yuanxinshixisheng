...
SHA = 'fe469a6a3701ed4ff641b1a207b8eb43f15d6cfc968af4e0f3afae024142a8fe'
...
def main():
    ...
    code = code.replace('velavision_device_intent_20260915', 'velavision_command_latency_20260917')
