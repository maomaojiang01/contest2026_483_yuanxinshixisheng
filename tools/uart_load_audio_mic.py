...
from verify_audio_mic_image import verify
...
previous_build = build.parent / 'audio-normal-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-normal-20260910/verification.json').read_text())
...
assert build.name == 'audio-mic-20260910'
