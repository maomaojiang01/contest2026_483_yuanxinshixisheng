...
P=R/'private/native-voice-link-audit';P.mkdir(exist_ok=True)
O=R/'evidence/native-voice-link-audit-20260911';O.mkdir(exist_ok=True)
...
import hashlib,json,subprocess,tarfile
from pathlib import Path
S=Path('/dev/shm/velavision-link-audit-20260911')
...
host='swl@192.168.152.131';dest='/dev/shm/velavision-link-audit-20260911'
