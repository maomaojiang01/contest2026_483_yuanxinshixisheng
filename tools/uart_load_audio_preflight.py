...
previous_build = build.parent / 'usb-readonly-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/usb-readonly-20260910/verification.json').read_text())
...
assert build.name == 'audio-preflight-20260910'
