...
from verify_audio_route_image import verify
...
previous_build = build.parent / 'audio-loopback-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-loopback-20260910/verification.json').read_text())
...
assert build.name == 'audio-route-20260910'
