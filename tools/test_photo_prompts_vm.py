...
files=['app/k7agent/cloud/include/device_photo_prompts.h',
       'app/k7agent/cloud/src/device_photo_prompts.c','host/whole_device/test_device_photo_prompts.c']
...
with tempfile.TemporaryDirectory() as folder:
 ...
 for opt in ['-O0','-O2']:
  subprocess.run(['gcc','-std=c11',opt,'-Wall','-Wextra','-Werror','-Iapp/k7agent/cloud/include',
   'host/whole_device/test_device_photo_prompts.c','app/k7agent/cloud/src/device_photo_prompts.c','-o','test'],cwd=root,check=True)
