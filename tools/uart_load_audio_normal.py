...
from verify_audio_normal_image import verify
...
previous_build = build.parent / 'audio-fifo-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-fifo-20260910/verification.json').read_text())
...
assert build.name == 'audio-normal-20260910'
