...
from verify_emmc_block_image import verify
...
previous_build = build.parent / 'emmc-gpt-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/emmc-gpt-20260910/verification.json').read_text())
...
assert build.name == 'emmc-block-20260910'
