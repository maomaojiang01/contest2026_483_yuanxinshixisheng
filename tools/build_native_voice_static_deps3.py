...
P=R/'private/native-static-deps3-stage';P.mkdir(exist_ok=True)
O=R/'evidence/native-static-deps3-20260911';O.mkdir(exist_ok=True)
remote=r'''
import json,shlex,subprocess,hashlib,tarfile
from pathlib import Path
S=Path('/dev/shm/velavision-static-deps3-20260911')
...
host='swl@192.168.152.131';dest='/dev/shm/velavision-static-deps3-20260911'
