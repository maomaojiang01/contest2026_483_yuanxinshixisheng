...
from verify_voice_native_image import verify
...
previous_build = build.parent / 'audio-guard-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-guard-20260910/verification.json').read_text())
...
assert build.name == 'voice-native-20260910'
