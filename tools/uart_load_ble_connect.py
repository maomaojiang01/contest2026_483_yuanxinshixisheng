...
from verify_ble_connect_image import verify
...
previous_build = build.parent / 'wifi-amsdu-index-20260909'
from verify_wifi_amsdu_index_image import verify as verify_previous
verify_previous(previous_build)
...
assert build.name == 'ble-connect-20260909'
