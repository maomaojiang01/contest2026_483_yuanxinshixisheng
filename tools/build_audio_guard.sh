...
cmake -S nuttx -B /dev/shm/velavision_audio_sound_20260910 -G Ninja \
  -DBOARD_CONFIG=kickpi_k7:velavision_audio_sound_local
cmake --build /dev/shm/velavision_audio_sound_20260910 --target resetconfig
cmake --build /dev/shm/velavision_audio_sound_20260910 -j4
