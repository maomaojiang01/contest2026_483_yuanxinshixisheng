...
SHA = '97dcd424366b8973bebb323db7fc2dc5e87d326f8d8129a18a2d68d96dd0fab3'
...
def main():
    ...
    code = code.replace('velavision_device_intent_20260915', 'velavision_native_chat_cue_20260915')
