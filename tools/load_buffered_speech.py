...
out=p/'evidence/board-speech-buffered-20260914';out.mkdir(exist_ok=True)
fw=pathlib.Path('/home/swl/openvela/cmake_out/velavision_board_speech_buffered_20260914/nuttx.bin').read_bytes()
assert len(fw)==2791336 and hashlib.sha256(fw).hexdigest()=='e4a5cbdb642d905efa19ac0534310fc0f695a9551a6a45f3caf4797a144f09a4'
...
if __name__ == '__main__':
    out=ROOT/'evidence/board-speech-buffered-20260914'
