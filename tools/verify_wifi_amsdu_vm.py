...
SDK=Path('/home/swl/openvela');P=SDK/'work/velavision-project';OUT=SDK/'work/velavision-wifi-amsdu-20260909';OUT.mkdir(exist_ok=True)
report=dict(revision='wifi-amsdu-20260909',hardware_tested=False)
...
with (OUT/'build.log').open('w') as log:
    p=subprocess.run(['bash',str(P/'tools/build_wifi_ip.sh'),str(SDK)],stdout=log,stderr=subprocess.STDOUT)
