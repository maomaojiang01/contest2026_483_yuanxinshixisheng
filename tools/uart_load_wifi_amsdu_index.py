...
from verify_wifi_amsdu_index_image import verify
...
previous_build = build.parent / 'wifi-amsdu-20260909'
from verify_wifi_amsdu_image import verify as verify_previous
...
assert build.name == 'wifi-amsdu-index-20260909'
