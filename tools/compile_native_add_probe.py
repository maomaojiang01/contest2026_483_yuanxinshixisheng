...
R=Path(__file__).resolve().parents[1];P=R/'private/native-add-probe';P.mkdir(exist_ok=True)
O=R/'evidence/native-add-probe-compile-20260911';O.mkdir(exist_ok=True)
C=R/'work-in-progress/native-ort-add-probe'
remote=r'''
import hashlib,json,shlex,subprocess,tarfile
from pathlib import Path
S=Path('/dev/shm/velavision-native-add-probe-20260911')
...
host='swl@192.168.152.131';dest='/dev/shm/velavision-native-add-probe-20260911'
