...
from verify_model_arena_image import verify
...
previous_build = build.parent / 'wifi-arp-20260909'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/wifi-arp-20260909/verification.json').read_text())
...
assert build.name == 'model-arena-20260910'
