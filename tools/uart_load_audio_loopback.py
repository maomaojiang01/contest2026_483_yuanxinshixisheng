...
previous_build = build.parent / 'audio-filter-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-filter-20260910/verification.json').read_text())
...
assert build.name == 'audio-loopback-20260910'
