...
SHA = 'a9ddaae467447079d0426b29da81b2114be0a6fdfb4193ff3a6c4ca69540cd29'
...
def main():
    ...
    assert len(fw) == 2807928 and hashlib.sha256(fw).hexdigest() == SHA
    code = CODE.replace('device-intent-20260915', REV)
    code = code.replace('velavision_device_intent_20260915', 'velavision_hello_keyword_20260916')
    code = code.replace('2799680', '2807928')
