...
P = R / 'private/native-sherpa-link1'
O = R / 'evidence/native-sherpa-link1-20260911'
...
O=Path('/home/swl/openvela/work/native-sherpa-config2-20260911/link1')
...
subprocess.run(['scp.exe',*options,str(P/'audit.py'),host+':'+dest+'/audit-sherpa-capi.py'],check=True)
subprocess.run(['ssh.exe',*options,host,'python3 '+dest+'/audit-sherpa-capi.py'],check=True)
subprocess.run(['scp.exe',*options,host+':/home/swl/openvela/work/native-sherpa-config2-20260911/link1/results.tar.gz',str(P/'results.tar.gz')],check=True)
