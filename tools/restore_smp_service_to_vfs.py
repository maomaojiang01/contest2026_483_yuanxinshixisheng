...
from verify_emmc_vfs_recovery import verify
...
previous_build = build.parent / 'smp-service-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/smp-service-20260910/verification.json').read_text())
...
assert build.name == 'emmc-vfs-20260910'
