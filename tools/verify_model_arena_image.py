...
def verify(build):
    build=Path(build).resolve();assert build==ROOT/'artifacts/model-arena-20260910'
    report=json.loads((ROOT/'evidence/build/model-arena-20260910/verification.json').read_text())
...
if __name__=='__main__':print(verify(ROOT/'artifacts/model-arena-20260910'))
