...
R=Path(__file__).resolve().parents[1];E=R/'evidence/storage-types-inputs-20260910';E.mkdir(exist_ok=True)
script=r'''
import base64,hashlib,json
from pathlib import Path
N=Path('/home/swl/openvela/nuttx')
paths=[N/'include/nuttx/fs/ioctl.h',N/'include/nuttx/fs/inode.h',N/'fs/inode/fs_inodesearch.c',N/'include/nuttx/fs/fs.h']
out=[]
for p in paths:
