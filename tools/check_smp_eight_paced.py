...
assert not (E/'diagnostic-attempt02.json').exists()
...
(E/'diagnostic-attempt02.bin').write_bytes(buf)
...
(E/'diagnostic-attempt02.json').write_text(json.dumps(result,indent=2)+'\n')
