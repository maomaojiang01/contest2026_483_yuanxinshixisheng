...
try:
 ...
 time.sleep(.5)
 command('k7sound replay 10','SOUND result=',10)
 command('k7sound dump','SOUND_PCM_END',50)
finally:s.close()
'''
out=Path(__file__).resolve().parents[1]/'evidence/stage-watch-20260916/mic-replay-mono.log'
