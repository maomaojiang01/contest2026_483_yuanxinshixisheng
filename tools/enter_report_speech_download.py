...
assert b'integration_panel.py' in Path('/proc/46465/cmdline').read_bytes()
os.kill(46465,signal.SIGTERM);time.sleep(.5)
...
(ROOT/'evidence/report-speech-20260917/enter-download.log').write_bytes(out)
