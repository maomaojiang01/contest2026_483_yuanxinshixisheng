...
def verify(build):
    build=Path(build).resolve();assert build==ROOT/'artifacts/wifi-ip-20260909'
    report=json.loads((ROOT/'evidence/build/wifi-ip-20260909/verification.json').read_text())
...
if __name__=='__main__':print(verify(ROOT/'artifacts/wifi-ip-20260909'))
