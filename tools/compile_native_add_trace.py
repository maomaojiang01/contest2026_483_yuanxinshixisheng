...
R=Path(__file__).resolve().parents[1];P=R/'private/native-add-trace';P.mkdir(exist_ok=True)
O=R/'evidence/native-add-trace-compile-20260911';O.mkdir(exist_ok=True)
C=R/'work-in-progress/native-ort-add-trace'
remote=r'''
import hashlib,json,shlex,subprocess,tarfile
from pathlib import Path
S=Path('/dev/shm/velavision-native-add-trace-20260911')
...
host='swl@192.168.152.131';dest='/dev/shm/velavision-native-add-trace-20260911'
