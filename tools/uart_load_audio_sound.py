...
from verify_audio_sound_image import verify
...
previous_build = build.parent / 'audio-io-b-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-io-b-20260910/verification.json').read_text())
...
assert build.name == 'audio-sound-20260910'
