...
from verify_audio_input_image import verify
...
previous_build = build.parent / 'audio-gain-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-gain-20260910/verification.json').read_text())
...
assert build.name == 'audio-input-20260910'
