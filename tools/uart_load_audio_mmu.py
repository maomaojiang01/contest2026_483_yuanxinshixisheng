...
previous_build = build.parent / 'audio-marker-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-marker-20260910/verification.json').read_text())
...
assert build.name == 'audio-mmu-20260910'
