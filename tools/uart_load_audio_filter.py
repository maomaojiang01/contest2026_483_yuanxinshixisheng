...
from verify_audio_filter_image import verify
...
previous_build = build.parent / 'audio-input-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-input-20260910/verification.json').read_text())
...
assert build.name == 'audio-filter-20260910'
