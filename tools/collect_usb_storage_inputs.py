...
R=Path(__file__).resolve().parents[1];E=R/'evidence/usb-storage-inputs-20260910';E.mkdir(exist_ok=True)
script=r'''
import base64,hashlib,json
from pathlib import Path
N=Path('/home/swl/openvela/nuttx')
paths=[N/'drivers/usbhost/usbhost_storage.c',N/'drivers/usbhost/Kconfig',N/'include/nuttx/usb/usbhost.h',N/'include/nuttx/fs/fs.h',N/'include/sys/mount.h']
paths+=list((N/'fs/fat').glob('*.c'))+list((N/'fs/fat').glob('*.h'))+[N/'fs/fat/Kconfig']
out=[]
for p in paths:
