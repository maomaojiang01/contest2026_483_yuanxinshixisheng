...
from verify_emmc_gpt_image import verify
...
previous_build = build.parent / 'emmc-readonly-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/emmc-readonly-20260910/verification.json').read_text())
...
assert build.name == 'emmc-gpt-20260910'
