...
R=Path(__file__).resolve().parents[1];P=R/'private/native-sherpa-asr-build1';P.mkdir(exist_ok=True)
O=R/'evidence/native-sherpa-asr-build1-20260911';O.mkdir(exist_ok=True)
remote=r'''
import hashlib,json,shlex,subprocess,tarfile,time
from pathlib import Path
S=Path('/home/swl/openvela/work/native-sherpa-config2-20260911');O=S/'compile-attempt1';O.mkdir()
