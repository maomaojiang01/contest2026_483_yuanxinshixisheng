...
from verify_audio_reset_image import verify
...
previous_build = build.parent / 'audio-rxtrace-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-rxtrace-20260910/verification.json').read_text())
...
assert build.name == 'audio-reset-20260910'
