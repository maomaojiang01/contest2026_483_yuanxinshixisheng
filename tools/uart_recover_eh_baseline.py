...
from verify_neon_file64_image import verify
...
previous_build = build.parent / 'neon-file64-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/neon-file64-20260910/verification.json').read_text())
...
assert build.name == 'neon-file64-20260910'
