...
"""
r=subprocess.run(SSH[:-1]+['-o','ConnectTimeout=8',SSH[-1],'python3 -'],input=code.encode(),stdout=subprocess.PIPE,stderr=subprocess.PIPE,timeout=50)
out=r.stdout+r.stderr
(ROOT/'evidence/photo-foreground-20260917/enter-download.log').write_bytes(out)
