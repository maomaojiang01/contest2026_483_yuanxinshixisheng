...
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/wifi-amsdu-index-20260909/verification.json').read_text())
...
assert build.name == 'wifi-arp-20260909'
