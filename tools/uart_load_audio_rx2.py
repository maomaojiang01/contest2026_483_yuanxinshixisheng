...
from verify_audio_rx2_image import verify
...
previous_build = build.parent / 'audio-mmu-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-mmu-20260910/verification.json').read_text())
...
assert build.name == 'audio-rx2-20260910'
