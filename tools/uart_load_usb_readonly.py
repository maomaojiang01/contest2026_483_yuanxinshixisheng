...
previous_build = build.parent / 'arena-provider-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/arena-provider-20260910/verification.json').read_text())
...
assert build.name == 'usb-readonly-20260910'
