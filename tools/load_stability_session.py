...
SHA = '476d42ee2f03ddef7edb72807ff32765b4b40780b62642aa1c5483cec18c5168'
...
def main():
    ...
    assert len(fw) == 5007520 and hashlib.sha256(fw).hexdigest() == SHA
    code = CODE.replace('device-intent-20260915', REV)
    code = code.replace('velavision_device_intent_20260915', 'velavision_stability_session_20260917')
    code = code.replace('2799680', '5007520')
