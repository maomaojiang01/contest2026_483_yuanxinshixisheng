...
SHA = 'c4fb106fbdd6499d4b7cc54172aed0eb4fade6a71c39fe22db95f34b5b1e5b1f'
...
def main():
    ...
    code = code.replace('velavision_device_intent_20260915', 'velavision_side_yaw13_20260917')
