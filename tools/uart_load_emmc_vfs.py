...
from verify_emmc_vfs_image import verify
...
previous_build = build.parent / 'emmc-block-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/emmc-block-20260910/verification.json').read_text())
