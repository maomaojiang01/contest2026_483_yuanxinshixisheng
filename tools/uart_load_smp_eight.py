...
from verify_smp_eight_image import verify
...
previous_build = build.parent / 'smp-cross-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/smp-cross-20260910/verification.json').read_text())
...
assert build.name == 'smp-eight-20260910'
