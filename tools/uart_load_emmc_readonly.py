...
from verify_emmc_readonly_image import verify
...
previous_build = build.parent / 'model-arena-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/model-arena-20260910/verification.json').read_text())
...
assert build.name == 'emmc-readonly-20260910'
