...
SDK=Path('/home/swl/openvela');P=SDK/'work/velavision-project';OUT=SDK/'work/velavision-wifi-amsdu-index-20260909';OUT.mkdir(exist_ok=True)
report=dict(revision='wifi-amsdu-index-20260909',hardware_tested=False)
