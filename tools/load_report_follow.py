...
SHA = '3642d9155f8456d216ddb14cc4cacfb9139a6f19bc5997f507638a804306260b'
...
def main():
    ...
    code = code.replace('velavision_device_intent_20260915', 'velavision_report_follow_20260917')
