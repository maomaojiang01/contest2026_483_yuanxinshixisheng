...
O=R/'evidence/audio-mmu-input-20260910'
...
elf=mod.parse(R/'artifacts/audio-loopback-20260910/nuttx')
...
for rel,name in [('artifacts/audio-loopback-20260910/.config','config'),('port/new/nuttx/arch/arm64/src/rk3576/rk3576_boot.c','rk3576_boot.c')]:
