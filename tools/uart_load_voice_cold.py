...
previous_build = build.parent / 'voice-native-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/voice-native-20260910/verification.json').read_text())
...
assert build.name == 'voice-cold-20260910'
