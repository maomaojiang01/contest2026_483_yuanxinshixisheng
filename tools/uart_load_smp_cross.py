...
from verify_smp_cross_image import verify
...
previous_build = build.parent / 'smp-four-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/smp-four-20260910/verification.json').read_text())
...
assert build.name == 'smp-cross-20260910'
