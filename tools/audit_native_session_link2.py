...
P = R / 'private/native-session-link2'
O = R / 'evidence/native-session-link2-20260911'
...
subprocess.run(['scp.exe',*options,host+':'+dest+'/link-attempt2/results.tar.gz',str(P/'results.tar.gz')],check=True)
