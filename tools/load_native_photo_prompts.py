...
SHA = '8cbd147ad72a3b463e734ab42320d91d80219d2b978a6bdff6b83671011965d1'
...
def main():
    ...
    assert len(fw) == 2799728 and hashlib.sha256(fw).hexdigest() == SHA
    code = CODE.replace('device-intent-20260915', REV)
    code = code.replace('velavision_device_intent_20260915', 'velavision_native_photo_prompts_20260915')
    code = code.replace('2799680', '2799728')
