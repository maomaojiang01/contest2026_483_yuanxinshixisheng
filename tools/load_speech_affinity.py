...
out=p/'evidence/board-speech-affinity-20260914';out.mkdir(exist_ok=True)
fw=pathlib.Path('/home/swl/openvela/cmake_out/velavision_board_speech_affinity_20260914/nuttx.bin').read_bytes()
assert len(fw)==2791336 and hashlib.sha256(fw).hexdigest()=='66659d8c865190dd936b28884fadc2c0c3411eeeb0507c61ee493ab9c7e2976e'
...
if __name__ == '__main__':
    out=ROOT/'evidence/board-speech-affinity-20260914'
