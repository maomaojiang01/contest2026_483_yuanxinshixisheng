...
from verify_audio_marker_image import verify
...
previous_build = build.parent / 'audio-route-20260910'
import json
previous_report = json.loads((Path(__file__).resolve().parents[1] / 'evidence/build/audio-route-20260910/verification.json').read_text())
...
assert build.name == 'audio-marker-20260910'
