...
roots=['llama_model_load_from_file','llama_init_from_model','llama_decode','llama_tokenize','ggml_threadpool_new_checked']
...
if p.returncode==0:
 ...
 result['roots_present']={x:any(line.split()[-1]==x for line in out.splitlines() if line.split()) for x in roots}
