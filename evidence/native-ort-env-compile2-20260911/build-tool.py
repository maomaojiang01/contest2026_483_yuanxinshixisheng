...
O=R/'evidence/native-ort-env-compile2-20260911';O.mkdir(exist_ok=True)
...
from pathlib import Path
S=Path('/dev/shm/velavision-ort-env2-20260911')
...
host='swl@192.168.152.131';dest='/dev/shm/velavision-ort-env2-20260911'
